...
function CarDetails() {
  ...
  const [userEmail, setUserEmail] = useState('testuser@gmail.com'); // Placeholder until we link login auth
  ...
  return (
    <div style={{ minHeight: '90vh', backgroundColor: '#f8fafc', padding: '3rem 2rem', fontFamily: 'sans-serif' }}>
      <div style={{ maxWidth: '1000px', margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '3rem', alignItems: 'start' }}>
        ...
        <div style={{ backgroundColor: '#fff', borderRadius: '16px', border: '1px solid #e2e8f0', padding: '2rem', boxShadow: '0 4px 6px -1px rgba(0,0,0,0.05)' }}>
          <div style={{ fontSize: '5rem', backgroundColor: '#f1f5f9', borderRadius: '12px', height: '180px', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '1.5rem' }}>
          ...
          <p style={{ margin: '0 0 0.75rem 0', color: '#475569', fontWeight: '500' }}>📍 **Garaged at:** {car.hubName}</p>
          <p style={{ margin: '0 0 1.5rem 0', color: '#64748b', fontSize: '0.9rem', lineHeight: '1.5' }}>{car.address}</p>
          
          <div style={{ display: 'flex', gap: '2rem', padding: '1rem', backgroundColor: '#f8fafc', borderRadius: '10px', border: '1px solid #e2e8f0' }}>
            <div><span style={{ fontSize: '0.8rem', color: '#64748b', display: 'block' }}>Capacity</span><strong style={{ color: '#0f172a' }}>💺 {car.seats} Seats</strong></div>
            <div><span style={{ fontSize: '0.8rem', color: '#64748b', display: 'block' }}>Propulsion</span><strong style={{ color: '#0f172a' }}>⛽ {car.fuelType}</strong></div>
            <div><span style={{ fontSize: '0.8rem', color: '#64748b', display: 'block' }}>Rate</span><strong style={{ color: '#2563eb' }}>₹{car.pricePerDay}/day</strong></div>
          </div>
        </div>
        ...
        <div style={{ backgroundColor: '#fff', borderRadius: '16px', border: '1px solid #e2e8f0', padding: '2rem', boxShadow: '0 4px 6px -1px rgba(0,0,0,0.05)' }}>
          {bookingSuccess ? (
            <div style={{ textAlign: 'center', padding: '3rem 1rem' }}>
              ...
              <button onClick={() => navigate('/')} style={{ backgroundColor: '#0f172a', color: '#fff', border: 'none', padding: '0.85rem 1.5rem', borderRadius: '8px', fontWeight: '700', cursor: 'pointer', width: '100%' }}>Return to Homepage</button>
            </div>
          ) : (
            <form onSubmit={handleBookingSubmit}>
              ...
              <div style={{ marginBottom: '1.25rem' }}>
                ...
                <input type="email" value={userEmail} onChange={(e) => setUserEmail(e.target.value)} required style={{ width: '100%', padding: '0.75rem', borderRadius: '6px', border: '1px solid #cbd5e1', outline: 'none', boxSizing: 'border-box' }} />
              </div>
